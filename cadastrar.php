...
<body>
        ...
        <nav>
            ...
            <div class="iconsCrud">
                <ul>
                    ...
                    <li>
                        <form action="" method="POST"><input type="submit" class="logout-btn " name="logout" value="Sair"></form>
                    </li>
    ...
    <div class="options">
        <div>
            <ul>
                <li><a href="javascript:void(0)" onclick="toggleCadastro('produto')" data-tipo="produto">Produtos</a></li>
                <li><a href="javascript:void(0)" onclick="toggleCadastro('fornecedor')" data-tipo="fornecedor">Fornecedores</a></li>
            </ul>
        </div>


        <div class="conteudoCadastroProduto" id="conteudoCadastroProduto">
            <?php generateProductForm($result); ?>
        </div>
        <div class="conteudoCadastroFornecedor" id="conteudoCadastroFornecedor">
        </div>
        <div class="hidden">
        ...
        <script>
            ...
            function toggleCadastro(tipo) {
                ...
                // A botão clicado
                let buttons = document.querySelectorAll('.options ul li a');
                buttons.forEach(function(button) {
                    button.classList.remove('selected');
                });

                let selectedButton = document.querySelector(`a[data-tipo="${tipo}"]`);
